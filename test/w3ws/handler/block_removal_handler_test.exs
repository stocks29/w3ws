defmodule W3WS.Handler.BlockRemovalHandlerTest do
  use ExUnit.Case, async: true
  doctest W3WS.Handler.BlockRemovalHandler
  ...
  alias W3WS.Handler.BlockRemovalHandler
  ...
  defp setup_listener(tags = %{uri: uri}) do
    ...
    handler = {BlockRemovalHandler, handler: inner_handler, blocks: 1}
  ...
  defp setup_handler(_tags) do
    ...
    handler = {BlockRemovalHandler, handler: handler, blocks: 1}
